  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="images/4.jpeg" alt="Los Angeles" style="width:100%;">
            ...
            <div class="row">
                <div class="col-lg-7 offset-lg-4">
                    <div class="banner__item">
                        ...
                        <div class="banner__item__text">
                            <h2>Star Lift Converse City High Top Utility</h2>
                            <a href="#">Buy now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="banner__item banner__item--middle">
                        ...
                        <div class="banner__item__text">
                            <h2>Converse Chuck 70 x Ader Error -Limited Edition</h2>
                            <a href="#">Buy now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="banner__item banner__item--last">
                        ...
                        <div class="banner__item__text">
                            <h2>Converse Chuck 70 Plant Love Normad khaki</h2>
                            <a href="#">Buy now</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row product__filter">
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            <h6>Converse Chuck Taylor All Star 1V Easy-On Space Cruiser Boys</h6>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            <h6>Converse Unisex Chuck 70 Sneakers - Egret/Navy/Alligator Friend </h6>
                            <a href="#" class="add-cart">+ Add To Cart</a>
                            <div class="rating">
                                <i class="fa fa-star-o"></i>
                                <i class="fa fa-star-o"></i>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item sale">
                        ...
                        <div class="product__item__text">
                            <h6>Converse Chuck 70 Naturally Digital Women's Sneakers - Orange</h6>
                            <a href="#" class="add-cart">+ Add To Cart</a>
                            <div class="rating">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                    <div class="product__item sale">
                        ...
                        <div class="product__item__text">
                            <h6>Chuck Taylor All Star EVA Lift Platform Butterfly Shine - Kids</h6>
                            <a href="#" class="add-cart">+ Add To Cart</a>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            <h6>Converse Custom Chuck Taylor All Star Lugged Platform By You</h6>
                            <a href="#" class="add-cart">+ Add To Cart</a>
                            <div class="rating">
                                <i class="fa fa-star-o"></i>
                                <i class="fa fa-star-o"></i>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="categories__hot__deal">
                        <img src="img/sepatu_product_sale.png" alt="">
                ...
                <div class="col-lg-4 offset-lg-1">
                    <div class="categories__deal__countdown">
                        ...
                        <h2>Rick owens converse chuck 70 zebra sherpa</h2>
                        <p>IDR 650.000 - <s>IDR 1.000.000</s></p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="instagram__text">
                        <h2>Instagram</h2>
                        <h4>Ikuti dan dapatkan infromasi terbaru dari product kami.</h4>
                        <br/>
                        <h3>#Dreamshop_</h3>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <span><img src="img/icon/calendar.png" alt=""> 25 February 2023</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <span><img src="img/icon/calendar.png" alt=""> 11 Maret 2023</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <span><img src="img/icon/calendar.png" alt=""> 28 Mei 2023</span>
